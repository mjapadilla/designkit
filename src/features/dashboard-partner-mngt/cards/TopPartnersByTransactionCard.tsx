...
function TopPartnersByTransactionCard() {
  return (
    <div className="card shadow-none">
      <div className="flex">
        <div className="w-full">
          <h4 className="card-title">Top Partners By Transaction</h4>
...
export default TopPartnersByTransactionCard;
